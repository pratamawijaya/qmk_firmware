...
[_LOWER] = LAYOUT(
  ...
  KC_CAPS, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                       KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_PLUS, SC(KC_MINS),
...
[_RAISE] = LAYOUT(
  ...
  TO(1),  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, XXXXXXX,                        KC_PGUP, KC_PRVWD,   KC_UP, KC_NXTWD,KC_DLINE, KC_BSPC,
