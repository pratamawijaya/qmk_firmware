 ...
 * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  /   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TAB  |   ""  |   ,  |   .  |   P  |  Y  |                    |   J  |   L  |   U  |   Y  |   ;  | Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | ESC  |   A  |   O  |   E  |   U  |   I  |-------.    ,-------|   D  |   H  |   T  |   N  |   S  |  = - |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |LShift|   ;  |   Q  |   J  |   K  |   X  |-------|    |-------|   B  |   M  |   W |   V  |   Z  |RShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCtl | LAlt | LGUI |SPACE | /  MO2   /      \  MO3 \   |ENTER |RShift| RAlt | RCtl |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_DVORAK] = LAYOUT(
  ...
  KC_TAB,   KC_QUOT,KC_COMM, KC_DOT,  KC_P,    KC_Y,                      KC_J,    KC_L,    KC_U,    KC_Y, KC_SCLN,  KC_BSPC,
  KC_ESC,   KC_A,   KC_O,    KC_E,    KC_U,    KC_I,                      KC_D,    KC_H,    KC_T,    KC_N,    KC_S,  KC_EQL,
  KC_LSFT,  KC_SCLN,KC_Q,    KC_J,    KC_K,    KC_X, KC_MUTE,      XXXXXXX,KC_K,   KC_M,  KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
                KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, MO(_LOWER),    MO(_RAISE), KC_ENT, KC_RSFT, KC_RALT, KC_RCTL
),
/*
 * QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCtl | LAlt | LGUI |Space | /LOWER  /       \RAISE \  |Enter  | RCtl | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_CAPS,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,  KC_EQL,  KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,   XXXXXXX, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
            KC_LCTL, KC_LALT, KC_LGUI, KC_SPACE, MO(_LOWER),      MO(_RAISE), KC_ENTER, KC_RCTL, KC_RALT, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
[_LOWER] = LAYOUT(
  _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_QUOT,
  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                        KC_6,    KC_7,    KC_LCBR, KC_RCBR, KC_SLSH,  KC_EQL,
  KC_CAPS, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                       KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_PLUS, KC_MINS,
  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,      _______,S(KC_SCLN), KC_LBRC, KC_RBRC, KC_BSLS, S(KC_BSLS), _______,
 ...
 * | TO(0)|      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TO(1)| Ins  | Pscr | Menu |      |      |                    |      | PWrd |  Up  | NWrd | DLine| Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
// start implementation bongo cat wpm
...
// end implementation bongo cat wpm 
