...
[_DVORAK] = LAYOUT(
  ...
  KC_LSFT,  KC_SCLN,KC_Q,    KC_J,    KC_K,    KC_X, KC_MUTE,      XXXXXXX,KC_B,   KC_M,    KC_W,    KC_V,    KC_Z, KC_MINS,
...
[_LOWER] = LAYOUT(
  ...
  KC_CAPS, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                       KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_PLUS, S(KC_MINS),
  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,      _______,S(KC_SCLN), KC_LBRC, KC_RBRC, KC_BSLS, S(KC_BSLS), _______,
                       _______, _______, _______, _______, _______,       _______, _______, _______, TO(0), TO(1)
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * | TO(0)|      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
[_RAISE] = LAYOUT(
  TO(_DVORAK), _______ , _______ , _______ , _______ , _______,                           _______,  _______  , _______,  _______ ,  _______ ,_______,
  TO(_QWERTY),  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, XXXXXXX,                        KC_PGUP, KC_PRVWD,   KC_UP, KC_NXTWD,KC_DLINE, KC_BSPC,
